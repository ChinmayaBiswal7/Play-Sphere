  ...
  const drawScreen = () => {
    container.innerHTML = `
      <div style="display: flex; gap: 32px; justify-content: center; align-items: center; height: 100%; padding: 40px; font-family: 'Orbitron', sans-serif; box-sizing: border-box; width: 100%;">
        <!-- PVP Friendly Card -->
        <div class="multi-quickplay-card" id="btn-pvp-friend" style="flex: 1; max-width: 400px; height: 280px; box-sizing: border-box; background: linear-gradient(135deg, rgba(168,85,247,0.18) 0%, rgba(88,28,135,0.4) 100%); border: 2px solid #a855f7; border-radius: 16px; padding: 32px; text-align: center; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s; display: flex; flex-direction: column; align-items: center; justify-content: center;">
        ...
        <div class="multi-quickplay-card" id="btn-pvp-online" style="flex: 1; max-width: 400px; height: 280px; box-sizing: border-box; background: linear-gradient(135deg, rgba(16,185,129,0.18) 0%, rgba(5,150,105,0.4) 100%); border: 2px solid #10b981; border-radius: 16px; padding: 32px; text-align: center; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s; display: flex; flex-direction: column; align-items: center; justify-content: center;">
